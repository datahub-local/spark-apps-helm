...
{{- if .Values.scripts.configMapName -}}
{{- include "spark-apps.chartManagedName" (dict "root" . "name" .Values.scripts.configMapName) -}}
{{- else -}}
{{- printf "%s-scripts" (include "spark-apps.fullname" .) -}}
{{- end -}}
{{- end -}}
